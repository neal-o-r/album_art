...
def nearest_neighbours(train_data, train_labels, test_data, test_labels):
    ...
    print('Annoy Accuracy {}'.format(acc / len(test_data)))
...
train_f, train_cl, test_f, test_cl = get_data(train_dir, test_dir)
nearest_neighbours(train_f, train_cl, test_f, test_cl)
